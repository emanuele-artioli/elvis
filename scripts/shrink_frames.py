...
def process_frame_server_side(frame_name, experiment_folder, square_size, block_coords):
    ...
    frame = cv2.imread(f'{experiment_folder}/reference_frames/{frame_name}')
...
if __name__ == '__main__':
    ...
    frame_names = [frame_name for frame_name in os.listdir(f'{experiment_folder}/reference_frames') if frame_name.endswith('.png')]
